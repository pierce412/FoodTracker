...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            //saves the meals after a meal is deleted
            saveMeals()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            //get the destination view controller, the selected meal cell, and the index path of the selected cell.
    ...
    private func loadSampleMeals() {
        print ("got to load sample meals")
        ...
        guard let meal3 = Meal(name: "Fish and chips", photo: photo3, rating: 3) else {
            fatalError("Unable to instantiate meal2")
        }
    ...
    private func saveMeals() {
        ...
        //log to console if successful save or not
        if isSuccessfulSave {
